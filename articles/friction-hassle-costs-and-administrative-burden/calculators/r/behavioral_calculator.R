#!/usr/bin/env Rscript
# Self-contained behavioral calculator for Friction, Hassle Costs, and Administrative Burden
...
result <- data.frame(
  series = "Choice Architecture and Nudging",
  article = "Friction, Hassle Costs, and Administrative Burden",
